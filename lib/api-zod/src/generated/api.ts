...
export const GetStudentProgressResponse = zod.object({
  ...
  "notesOverriddenAt": zod.string().nullish().describe('Timestamp when an admin last overrode the lesson notes after submission'),
  "notesOverriddenByUserId": zod.number().nullish().describe('ID of the admin user who last overrode the notes'),
  "notesOverriddenByName": zod.string().nullish().describe('Display name of the admin who last overrode the notes (resolved on the server, present on GET \/assessments\/:id)'),
...
export const GetAssessmentResponse = zod.object({
  ...
  "assessmentType": zod.enum(['qsafe', 'qride', 'heavy_vehicle']).optional(),
  "pedalOperator": zod.enum(['student', 'instructor', 'shared']),
  "confidenceNote": zod.string().nullish(),
  "focusAreasNext": zod.string().nullish(),
  "preLessonBriefingAcknowledgedAt": zod.string().nullish(),
  "preDriveFitnessConfirmedAt": zod.string().nullish(),
  "finalizationStatus": zod.enum(['draft', 'pending_approval', 'approved', 'dispatched']).optional(),
  "approvedAt": zod.string().nullish(),
  "approvedByUserId": zod.number().nullish(),
  "reportDispatchedAt": zod.string().nullish(),
  ...
  "notesOverriddenAt": zod.string().nullish().describe('Timestamp when an admin last overrode the lesson notes after submission'),
  "notesOverriddenByUserId": zod.number().nullish().describe('ID of the admin user who last overrode the notes'),
  "notesOverriddenByName": zod.string().nullish().describe('Display name of the admin who last overrode the notes (resolved server-side)'),
