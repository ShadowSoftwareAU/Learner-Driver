...
/**
 * Transmission type of this vehicle
 */
export type InstructorVehicleTransmissionType = typeof InstructorVehicleTransmissionType[keyof typeof InstructorVehicleTransmissionType];


export const InstructorVehicleTransmissionType = {
  auto: 'auto',
  manual: 'manual',
} as const;
 ...
 */
export type InstructorVehicleControlType = typeof InstructorVehicleControlType[keyof typeof InstructorVehicleControlType];


export const InstructorVehicleControlType = {
...
export interface InstructorVehicle {
  ...
  /** Transmission type of this vehicle */
  transmissionType?: InstructorVehicleTransmissionType;
  /** dual_control = professionally fitted dual controls; factory = standard factory pedals */
  controlType?: InstructorVehicleControlType;
  isDualControl?: boolean;
...
export type InstructorVehicleInputTransmissionType = typeof InstructorVehicleInputTransmissionType[keyof typeof InstructorVehicleInputTransmissionType];


export const InstructorVehicleInputTransmissionType = {
  auto: 'auto',
  manual: 'manual',
} as const;

export type InstructorVehicleInputControlType = typeof InstructorVehicleInputControlType[keyof typeof InstructorVehicleInputControlType];


export const InstructorVehicleInputControlType = {
  dual_control: 'dual_control',
  factory: 'factory',
} as const;
...
export interface InstructorVehicleInput {
  ...
  regoState?: string;
  regoExpiry?: string;
  transmissionType?: InstructorVehicleInputTransmissionType;
  controlType?: InstructorVehicleInputControlType;
  isDualControl?: boolean;
  isOwnerOperator?: boolean;
  isPrimary?: boolean;
...
export interface CreateBooking {
  ...
  /** ID of the instructor vehicle the student selected for this lesson */
  vehicleId?: number;
}
...
export interface ViewerStudentDashboard {
  ...
  page?: number;
  /** Whether more lesson history pages exist beyond this page */
  hasMore?: boolean;
...
export type GenerateMyViewerCode200 = {
  viewerCode: string;
...
export type DeleteMyVehicle200 = {
  ok?: boolean;
};
...
export type GetViewerStudentDashboardParams = {
/**
 * Page number for lesson history (1-based, 10 results per page)
 * @minimum 1
 */
page?: number;
};
